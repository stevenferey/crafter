                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-[rgb(var(--color-surface))] rounded-lg shadow-lg border border-[rgb(var(--color-border))] py-1 z-50">
                    ...
                    <div className="py-1">
                      <Link
                        ...
                        className="w-full text-left px-4 py-2 text-sm text-[rgb(var(--color-text))] hover:bg-[rgb(var(--color-surface-hover))] transition-colors flex items-center space-x-2"
                      >
                        <svg
                          className="w-4 h-4"
                          fill="none"
